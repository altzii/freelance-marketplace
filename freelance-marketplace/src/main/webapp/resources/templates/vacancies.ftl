...
<div class="vacancies">
    ...
    <div class="content">
        <div class="inside">
            ...
            <div class="create">
                <a href="/customer/vacancies/add"><div class="button">Создать вакансию</div></a>
            </div>
            </@security.authorize>
            <div class="head">
            ...
            <div class="blocks">
            <#if vacancies??>
                <#list vacancies as vacancie>
                    <div class="block">
                        <div class="img"></div>
                        <div class="title">${vacancie.title}</div>
                        <div class="name">${vacancie.user.login}</div>
                        <a href="/vacancies/${vacancie.id}"><div class="button">Посмотреть</div></a>
                    </div>
                </#list>
            </#if>
            </div>
